...
export function urlBuilder({path, download, upload, delete:del, file, extract, rename}: { path: string, download?: boolean, upload?: boolean, file?:string, delete?:boolean, extract?: boolean, rename?: boolean }): string {
	const builder = []
