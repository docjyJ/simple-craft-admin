...
export default function UploadFilesModal({ closePath, path, opened }: UploadFilesModalProps) {
  ...
  return (
    <Modal onClose={() => navigate(closePath)} title="Upload file(s)" centered opened>
      <Form method="POST" encType="multipart/form-data" action={closePath}>
        ...
        <Group mt="md" justify="flex-end">
          <Button component={Link} to={closePath} variant="light" color="gray" type="button">
            Cancel
          </Button>
          <Button color="blue" type="submit" name="type" value="upload">
            Upload
          </Button>
        </Group>
      </Form>
